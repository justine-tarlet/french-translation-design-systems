...
Dans ce chapitre 4, nous apprendrons plus sur les flux de travail professionnels pour apporter des améliorations au design system tout en atténuant les incohérences. Ce chapitre présente les techniques permettant de recueillir des retours sur l'interface utilisateur et de parvenir à un consensus avec votre équipe.
...
Supprimer le node_modules. Réinstaller les packages. Effacer le stockage local.
